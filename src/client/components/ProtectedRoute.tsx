...
export function ProtectedRoute({
    ...
    if (isLoading || permissionsLoading) {
        // These were Tailwind utility classes (min-h-screen, flex, bg-base…)
        // but this project has no Tailwind, so none of them resolved — the
        // gate rendered as bare unstyled text in the top-left on every load.
        return (
