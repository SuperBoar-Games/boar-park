...
\restrict dWgedUr8VxnssVLGZqrbNUcgSeNxSKEFAgz6R5NJ7YeU9dgHbkAnNvAA77QBfXh
...
ALTER TABLE IF EXISTS ONLY public.user_game_roles DROP CONSTRAINT IF EXISTS user_game_roles_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_game_roles DROP CONSTRAINT IF EXISTS user_game_roles_role_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_game_roles DROP CONSTRAINT IF EXISTS user_game_roles_game_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.movies DROP CONSTRAINT IF EXISTS movies_hero_id_fkey;
ALTER TABLE IF EXISTS ONLY public.heroes DROP CONSTRAINT IF EXISTS heroes_game_id_fkey;
ALTER TABLE IF EXISTS ONLY public.cards DROP CONSTRAINT IF EXISTS cards_movie_id_fkey;
ALTER TABLE IF EXISTS ONLY public.cards DROP CONSTRAINT IF EXISTS cards_hero_id_fkey;
ALTER TABLE IF EXISTS ONLY public.card_tags DROP CONSTRAINT IF EXISTS card_tags_tag_id_fkey;
ALTER TABLE IF EXISTS ONLY public.card_tags DROP CONSTRAINT IF EXISTS card_tags_card_id_fkey;
DROP TRIGGER IF EXISTS trigger_refresh_movie_stats_on_movie_change ON public.movies;
DROP TRIGGER IF EXISTS trigger_refresh_movie_stats_on_card_change ON public.cards;
DROP TRIGGER IF EXISTS trigger_refresh_hero_stats_on_movie_change ON public.movies;
DROP TRIGGER IF EXISTS trigger_refresh_hero_stats_on_hero_change ON public.heroes;
DROP INDEX IF EXISTS public.idx_tag_stats_tag_id;
DROP INDEX IF EXISTS public.idx_tag_stats_card_count;
DROP INDEX IF EXISTS public.idx_movies_hero_title;
DROP INDEX IF EXISTS public.idx_movies_hero_id;
DROP INDEX IF EXISTS public.idx_movie_stats_movie_id;
DROP INDEX IF EXISTS public.idx_movie_stats_hero_id;
DROP INDEX IF EXISTS public.idx_movie_stats_done;
DROP INDEX IF EXISTS public.idx_heroes_game_id;
DROP INDEX IF EXISTS public.idx_hero_stats_industry;
DROP INDEX IF EXISTS public.idx_hero_stats_hero_id;
DROP INDEX IF EXISTS public.idx_hero_stats_game_id;
DROP INDEX IF EXISTS public.idx_cards_hero_movie_name;
DROP INDEX IF EXISTS public.idx_card_tags_tag_id;
DROP INDEX IF EXISTS public.idx_card_tags_card_id;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_username_key;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_email_key;
ALTER TABLE IF EXISTS ONLY public.user_game_roles DROP CONSTRAINT IF EXISTS user_game_roles_user_id_game_id_role_id_key;
ALTER TABLE IF EXISTS ONLY public.user_game_roles DROP CONSTRAINT IF EXISTS user_game_roles_pkey;
...
ALTER TABLE IF EXISTS ONLY public.password_resets DROP CONSTRAINT IF EXISTS password_resets_token_key;
...
ALTER TABLE IF EXISTS ONLY public.heroes DROP CONSTRAINT IF EXISTS heroes_game_id_name_key;
ALTER TABLE IF EXISTS ONLY public.games DROP CONSTRAINT IF EXISTS games_slug_key;
ALTER TABLE IF EXISTS ONLY public.games DROP CONSTRAINT IF EXISTS games_pkey;
ALTER TABLE IF EXISTS ONLY public.games DROP CONSTRAINT IF EXISTS games_name_key;
ALTER TABLE IF EXISTS ONLY public.cards DROP CONSTRAINT IF EXISTS cards_pkey;
ALTER TABLE IF EXISTS ONLY public.card_tags DROP CONSTRAINT IF EXISTS card_tags_pkey;
ALTER TABLE IF EXISTS public.users ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.user_game_roles ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.user_game_roles_id_seq;
DROP TABLE IF EXISTS public.user_game_roles;
DROP SEQUENCE IF EXISTS public.tags_id_seq;
DROP MATERIALIZED VIEW IF EXISTS public.tag_stats;
...
DROP MATERIALIZED VIEW IF EXISTS public.movie_stats;
...
DROP TABLE IF EXISTS public.card_tags;
DROP FUNCTION IF EXISTS public.refresh_movie_stats_trigger();
DROP FUNCTION IF EXISTS public.refresh_hero_stats_trigger();
...
--
-- Name: refresh_hero_stats_trigger(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: refresh_movie_stats_trigger(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: movie_stats; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--
...
--
-- Name: hero_stats; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--
...
--
-- Name: tag_stats; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--
...
--
-- Name: user_game_roles; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: user_game_roles_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: user_game_roles_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: user_game_roles id; Type: DEFAULT; Schema: public; Owner: -
--
...
33	6	Ala Vaikuntapuramlo	f	2025-04-26 18:28:30+02	admin	f
...
--
-- Name: heroes heroes_game_id_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_game_roles user_game_roles_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_game_roles user_game_roles_user_id_game_id_role_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_card_tags_card_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_card_tags_tag_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cards_hero_movie_name; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_hero_stats_game_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_hero_stats_hero_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_hero_stats_industry; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_heroes_game_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_movie_stats_done; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_movie_stats_hero_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_movie_stats_movie_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_movies_hero_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_movies_hero_title; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tag_stats_card_count; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tag_stats_tag_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: heroes trigger_refresh_hero_stats_on_hero_change; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: movies trigger_refresh_hero_stats_on_movie_change; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: cards trigger_refresh_movie_stats_on_card_change; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: movies trigger_refresh_movie_stats_on_movie_change; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: card_tags card_tags_card_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cards cards_hero_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cards cards_movie_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: heroes heroes_game_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: movies movies_hero_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_game_roles user_game_roles_game_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_game_roles user_game_roles_role_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_game_roles user_game_roles_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: movie_stats; Type: MATERIALIZED VIEW DATA; Schema: public; Owner: -
--
...
--
-- Name: hero_stats; Type: MATERIALIZED VIEW DATA; Schema: public; Owner: -
--
...
--
-- Name: tag_stats; Type: MATERIALIZED VIEW DATA; Schema: public; Owner: -
--
...
\unrestrict dWgedUr8VxnssVLGZqrbNUcgSeNxSKEFAgz6R5NJ7YeU9dgHbkAnNvAA77QBfXh
